<ul class="list-unstyled mb-0 profile-overview-menus">
    <li class="py-3 profile-overview-menu profile-overview-switch active" data-target-block="#profileDetails">
    ...
    <!-- password -->
    <li class="py-3 profile-overview-menu profile-overview-switch" data-target-block="#passwordDetails">
        <a href="javascript:void(0)" class="text-muted d-flex align-items-center">
    ...
    <!-- security -->
    <li class="py-3 profile-overview-menu profile-overview-switch" data-target-block="#securityDetails">
        <a href="javascript:void(0)" class="text-muted d-flex align-items-center">
    ...
    <li class="py-3 profile-overview-menu">
