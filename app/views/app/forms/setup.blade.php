...
@section('content')
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-6 col-12 mb-md-5 mb-sm-4">
            ...
            <div class="col-12 mb-md-5 mb-sm-4">
                <div class="card">
                    <div class="card-header py-3">
                        ...
                        <form action="{{ route('forms.setup.update', 'submission', $form->id) }}" method="POST" id="submissionSetupForm" onsubmit="submitForm(event)">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="submissionUrl" class="form-label d-block">Submission URL</label>
                                    <small class="text-muted fs-10 ms-3 d-block">Leave empty to keep submitting within the app</small>
                                    <input type="text" class="form-control" placeholder="External Sumission url" id="submissionUrl" name="submission_url" value="{{ $form->submission_url }}">
                                </div>
                                <div class="col-md-6 col-12 mb-3">
